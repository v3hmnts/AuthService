...
public class AuthController {
    ...
    public ResponseEntity<ServiceAuthResponse> createInternalServiceToken(@Valid @RequestHeader(name = "x-api-key") String apiKey) throws Exception {
        ServiceAuthResponse authResponse = tokenService.createNewServiceToken(apiKey);
        return ResponseEntity.ok(authResponse);
    }
